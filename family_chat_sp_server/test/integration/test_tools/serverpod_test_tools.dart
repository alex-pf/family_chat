...
import 'package:serverpod_auth_core_server/serverpod_auth_core_server.dart'
    as _i4;
import 'package:family_chat_sp_server/src/generated/user.dart' as _i5;
import 'package:family_chat_sp_server/src/generated/user_role.dart' as _i6;
import 'package:family_chat_sp_server/src/generated/chat_admin_info.dart'
    as _i7;
import 'package:family_chat_sp_server/src/generated/storage_stats.dart' as _i8;
import 'package:family_chat_sp_server/src/generated/file_deletion_preview.dart'
    as _i9;
import 'package:family_chat_sp_server/src/generated/chat.dart' as _i10;
import 'package:family_chat_sp_server/src/generated/chat_list_item.dart'
    as _i11;
import 'package:family_chat_sp_server/src/generated/message.dart' as _i12;
import 'package:family_chat_sp_server/src/generated/message_reaction.dart'
    as _i13;
import 'package:family_chat_sp_server/src/generated/chat_stream_event.dart'
    as _i14;
import 'package:family_chat_sp_server/src/generated/greetings/greeting.dart'
    as _i15;
import 'package:family_chat_sp_server/src/generated/protocol.dart';
import 'package:family_chat_sp_server/src/generated/endpoints.dart';
...
class _AdminEndpoint {
      ...
      try {
        ...
        var _localReturnValue =
            await (_localCallContext.method.call(
                ...
                as _i3.Future<List<_i7.ChatAdminInfo>>);
        return _localReturnValue;
      } finally {
        await _localUniqueSession.close();
      }
  ...
  _i3.Future<void> deleteArchivedChat(
    _i1.TestSessionBuilder sessionBuilder,
    int chatId,
  ) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      var _localUniqueSession =
          (sessionBuilder as _i1.InternalTestSessionBuilder).internalBuild(
            endpoint: 'admin',
            method: 'deleteArchivedChat',
          );
      try {
        var _localCallContext = await _endpointDispatch.getMethodCallContext(
          createSessionCallback: (_) => _localUniqueSession,
          endpointPath: 'admin',
          methodName: 'deleteArchivedChat',
          parameters: _i1.testObjectToJson({'chatId': chatId}),
          serializationManager: _serializationManager,
        );
        var _localReturnValue =
      ...
      try {
        ...
        var _localReturnValue =
            await (_localCallContext.method.call(
                ...
                as _i3.Future<_i8.StorageStats>);
        return _localReturnValue;
      } finally {
        await _localUniqueSession.close();
      }
  ...
  _i3.Future<void> setFileSizeLimit(
    _i1.TestSessionBuilder sessionBuilder,
    int bytes,
  ) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      ...
      try {
        var _localCallContext = await _endpointDispatch.getMethodCallContext(
          createSessionCallback: (_) => _localUniqueSession,
          endpointPath: 'admin',
          methodName: 'setFileSizeLimit',
          parameters: _i1.testObjectToJson({'bytes': bytes}),
          serializationManager: _serializationManager,
        );
        var _localReturnValue =
            await (_localCallContext.method.call(
  ...
  _i3.Future<_i9.FileDeletionPreview> getFilesOlderThan(
    _i1.TestSessionBuilder sessionBuilder,
    int days,
  ) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      var _localUniqueSession =
          (sessionBuilder as _i1.InternalTestSessionBuilder).internalBuild(
            endpoint: 'admin',
            method: 'getFilesOlderThan',
          );
      try {
        var _localCallContext = await _endpointDispatch.getMethodCallContext(
          createSessionCallback: (_) => _localUniqueSession,
          endpointPath: 'admin',
          methodName: 'getFilesOlderThan',
        ...
        var _localReturnValue =
            await (_localCallContext.method.call(
                ...
                as _i3.Future<_i9.FileDeletionPreview>);
        return _localReturnValue;
      } finally {
        await _localUniqueSession.close();
      }
  ...
  _i3.Future<void> deleteFilesOlderThan(
    _i1.TestSessionBuilder sessionBuilder,
    int days,
  ) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      var _localUniqueSession =
          (sessionBuilder as _i1.InternalTestSessionBuilder).internalBuild(
            endpoint: 'admin',
            method: 'deleteFilesOlderThan',
          );
      try {
        var _localCallContext = await _endpointDispatch.getMethodCallContext(
          createSessionCallback: (_) => _localUniqueSession,
          endpointPath: 'admin',
          methodName: 'deleteFilesOlderThan',
          parameters: _i1.testObjectToJson({'days': days}),
          serializationManager: _serializationManager,
        );
        var _localReturnValue =
...
class _AuthEndpoint {
  ...
  _i3.Future<String> approveAskAdmin(
    _i1.TestSessionBuilder sessionBuilder,
    ...
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      var _localUniqueSession =
          (sessionBuilder as _i1.InternalTestSessionBuilder).internalBuild(
            endpoint: 'auth',
            method: 'approveAskAdmin',
          );
      try {
        var _localCallContext = await _endpointDispatch.getMethodCallContext(
          createSessionCallback: (_) => _localUniqueSession,
          endpointPath: 'auth',
          methodName: 'approveAskAdmin',
          parameters: _i1.testObjectToJson({
  ...
  _i3.Future<String> loginWithToken(
    _i1.TestSessionBuilder sessionBuilder,
    String token,
  ) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
...
class _ChatEndpoint {
  ...
  _i3.Future<_i10.Chat> createOrGetDirectChat(
    _i1.TestSessionBuilder sessionBuilder,
    int otherUserId,
  ) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      var _localUniqueSession =
          (sessionBuilder as _i1.InternalTestSessionBuilder).internalBuild(
            endpoint: 'chat',
            method: 'createOrGetDirectChat',
          );
      try {
        var _localCallContext = await _endpointDispatch.getMethodCallContext(
          createSessionCallback: (_) => _localUniqueSession,
          endpointPath: 'chat',
          methodName: 'createOrGetDirectChat',
      ...
      try {
        ...
        var _localReturnValue =
            await (_localCallContext.method.call(
                ...
                as _i3.Future<List<_i11.ChatListItem>>);
        return _localReturnValue;
      } finally {
        await _localUniqueSession.close();
      }
  ...
  _i3.Future<_i10.Chat> getChatDetails(
    _i1.TestSessionBuilder sessionBuilder,
    int chatId,
  ) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
...
class _MessageEndpoint {
      ...
      try {
        ...
        var _localReturnValue =
            await (_localCallContext.method.call(
                ...
                as _i3.Future<_i13.MessageReaction>);
        return _localReturnValue;
      } finally {
        await _localUniqueSession.close();
      }
  ...
  _i3.Stream<_i14.ChatStreamEvent> chatStream(
    _i1.TestSessionBuilder sessionBuilder,
    int chatId,
  ) {
...
class _UserEndpoint {
  ...
  _i3.Future<_i5.AppUser> updateProfile(
    _i1.TestSessionBuilder sessionBuilder,
    String name,
  ) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
  ...
  _i3.Future<List<_i5.AppUser>> getUsersInChat(
    _i1.TestSessionBuilder sessionBuilder,
    int chatId,
  ) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
